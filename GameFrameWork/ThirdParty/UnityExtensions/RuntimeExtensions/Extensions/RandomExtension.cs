...
namespace UnityExtensions
{
    ...
    public static partial class Extension
    {
        ...
        public static Vector3 InsideEllipsoid(this Random random, Vector3 radius)
        {
            return Vector3.Scale(random.InsideUnitSphere(), radius);
        }


        public static float InsideRange(this Random random, Range range)
        {
        ...
        public static Vector3 InsideRange3(this Random random, Range3 range3)
        {
            return new Vector3(
        ...
        public static int Choose(this Random random, Func<int, float> getProbability, int startIndex, int count)
        {
        ...
        /// <returns> 被选中的元素索引 </returns>
        public static int Choose(this Random random, IList<float> probabilities, int startIndex = 0, int count = 0)
        {
        ...
        public static void Sort<T>(this Random random, IList<T> list, int startIndex = 0, int count = 0)
        {
